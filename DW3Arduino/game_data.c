...
void TileMap_LoadFromIndex( TileMap_t* tileMap, u32 index )
{
   switch( index )
   {
      ...
      case 6: // Aliahan Castle 1F Main
         TileMap_LoadTileTexturesFromSetIndex( tileMap, 1 );
         TileMap_LoadInitialData( tileMap, 30, 32, False, False, False, False, 22, 0, 7, True, 0, 0 );
         TileMap_LoadStaticSpriteTexturesFromSetIndex( tileMap, 1 );
         TileMap_LoadStaticSpriteData( tileMap->staticSprites + 0, 19, 433, False );
         TileMap_LoadStaticSpriteData( tileMap->staticSprites + 1, 19, 436, False );
         TileMap_LoadStaticSpriteData( tileMap->staticSprites + 2, 19, 463, False );
         TileMap_LoadStaticSpriteData( tileMap->staticSprites + 3, 19, 466, False );
         TileMap_LoadStaticSpriteData( tileMap->staticSprites + 4, 19, 493, False );
         TileMap_LoadStaticSpriteData( tileMap->staticSprites + 5, 19, 496, False );
         TileMap_LoadStaticSpriteData( tileMap->staticSprites + 6, 4, 315, True );
         TileMap_LoadStaticSpriteData( tileMap->staticSprites + 7, 20, 129, False );
         TileMap_LoadStaticSpriteData( tileMap->staticSprites + 8, 20, 455, False );
         TileMap_LoadStaticSpriteData( tileMap->staticSprites + 9, 20, 567, False );
         TileMap_LoadStaticSpriteData( tileMap->staticSprites + 10, 20, 863, False );
         TileMap_LoadStaticSpriteData( tileMap->staticSprites + 11, 21, 275, False );
         TileMap_LoadStaticSpriteData( tileMap->staticSprites + 12, 17, 620, False );
         TileMap_LoadStaticSpriteData( tileMap->staticSprites + 13, 17, 622, False );
         TileMap_LoadStaticSpriteData( tileMap->staticSprites + 14, 17, 710, False );
         TileMap_LoadStaticSpriteData( tileMap->staticSprites + 15, 17, 712, False );
         TileMap_LoadStaticSpriteData( tileMap->staticSprites + 16, 15, 242, True );
         TileMap_LoadStaticSpriteData( tileMap->staticSprites + 17, 15, 243, True );
         TileMap_LoadStaticSpriteData( tileMap->staticSprites + 18, 15, 272, True );
         TileMap_LoadStaticSpriteData( tileMap->staticSprites + 19, 15, 273, True );
         TileMap_LoadStaticSpriteData( tileMap->staticSprites + 20, 15, 302, True );
         TileMap_LoadStaticSpriteData( tileMap->staticSprites + 21, 15, 303, True );
         TileMap_LoadActiveSpriteTexturesFromSetIndex( tileMap, 0 );
         TileMap_LoadPortalData( tileMap->portals + 0, 943, 1, 152, Direction_Down );
         ...
         TileMap_LoadPortalData( tileMap->portals + 5, 141, 8, 49, Direction_Right );
         TileMap_LoadPortalData( tileMap->portals + 6, 315, 11, 408, Direction_Right );
         ...
         memcpy( tileMap->tiles, g_mapTiles6, sizeof( u16 ) * 960 );
         break;
      ...
      case 11: // Aliahan Castle Throne Room
         ...
         TileMap_LoadActiveSpriteTexturesFromSetIndex( tileMap, 0 );
         TileMap_LoadPortalData( tileMap->portals + 0, 408, 6, 315, Direction_Left );
      ...
      case 18: // Promontory Cave B2 Stairs
         ...
         TileMap_LoadPortalData( tileMap->portals + 2, 28, 19, 2219, Direction_Right );
      ...
      case 19: // Najima B1 Main
         ...
         TileMap_LoadActiveSpriteTexturesFromSetIndex( tileMap, 0 );
         TileMap_LoadPortalData( tileMap->portals + 0, 2219, 18, 28, Direction_Left );
         TileMap_LoadPortalData( tileMap->portals + 1, 1887, 10, 34, Direction_Right );
         TileMap_LoadPortalData( tileMap->portals + 2, 153, 12, 1001, Direction_Right );
         TileMap_LoadPortalData( tileMap->portals + 3, 557, 20, 48, Direction_Left );
         TileMap_LoadPortalData( tileMap->portals + 4, 611, 20, 58, Direction_Left );
         TileMap_LoadPortalData( tileMap->portals + 5, 688, 21, 14, Direction_Down );
         TileMap_LoadPortalData( tileMap->portals + 6, 689, 21, 15, Direction_Down );
         TileMap_LoadPortalData( tileMap->portals + 7, 2235, 22, 1343, Direction_Right );
      ...
      case 20: // Najima B1 West Room
         ...
         TileMap_LoadActiveSpriteTexturesFromSetIndex( tileMap, 0 );
         TileMap_LoadPortalData( tileMap->portals + 0, 49, 19, 558, Direction_Right );
         TileMap_LoadPortalData( tileMap->portals + 1, 59, 19, 612, Direction_Right );
      ...
      case 21: // Najima B1 East Room
         ...
         TileMap_LoadActiveSpriteTexturesFromSetIndex( tileMap, 0 );
         TileMap_LoadPortalData( tileMap->portals + 0, 4, 19, 634, Direction_Up );
         TileMap_LoadPortalData( tileMap->portals + 1, 5, 19, 635, Direction_Up );
