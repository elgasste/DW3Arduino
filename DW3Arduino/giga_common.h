...
#define KVSTORE_HAS_SHIP_KEY              "hasShip"
#define KVSTORE_HAS_RAMIA_KEY             "hasRamia"
...
#define KVSTORE_PLAYER_GENDER_KEY         "player%d_gender"
...
#define KVSTORE_ERROR_GAME_BASE_WRITE     "could not write game base data to KV Store"
#define KVSTORE_ERROR_PLAYER_WRITE        "could not write player data to KV Store"

#define KVSTORE_ERROR_GAME_BASE_READ      "could not read game base data from KV Store"
